...
const char k_usageText[] =
  ...
  -p/--package <packageName>   Java app package (com.example.app) (for Java or Dotnet)\n\
\n\
...
protected:
    ...
    string m_dotnetPackageName;             /*!< Used dotnet package. */
        ...
        while ((optchar = options(iter, optarg)))
        {
            switch (optchar)
            {
                ...
                case 'g':
                {
                    ...
                    {
                        m_outputLanguage = languages_t::kDotnetLanguage;
                    }
                    else
                    {
    ...
    int run()
    {
        try
        {
            ...
            switch (m_outputLanguage)
            {
                ...
                case languages_t::kDotnetLanguage:
                {
                    DotnetGenerator(&def, m_dotnetPackageName).generate();
                    break;
                }
            }
        }
